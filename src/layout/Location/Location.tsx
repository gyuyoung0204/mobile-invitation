...
const LocationWrapper = styled.div`
  ...
  @media (max-width: 768px) {
    ...
    height: auto; /* 모바일에서 콘텐츠 높이에 맞춤 */
    max-width: 100%; /* 모바일에서 너비 제한 해제 */
    padding: 15px; /* 모바일에서 여백 추가 */
...
const MapContainer = styled.div`
  ...
  height: 70%; /* 데스크톱 비율에 맞게 지도 높이 설정 */
  margin: 20px 0; /* 지도와 다른 콘텐츠 간격 설정 */
  display: flex;
